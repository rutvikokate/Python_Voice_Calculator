...
root.geometry("380x580+500+60")
root.maxsize(380,580)
root.minsize(20,20)
...
stop=PhotoImage(file='res/stop.png')
...
Dot.grid(row=7, column=4, padx=0, pady=(2,15))
...
Power.grid(row=7, column=3, padx=0, pady=(2,15))
...
Voice =Button(root, command = Voice,border=0, relief=SOLID,width=180,height=50,fg='white',font=('Calibri',15),bg='#002BFF',image=ok,activebackground='#002BFF')
Voice.grid(row=8, column=1,columnspan=2)
Stop =Button(root, command = Voice, border=0, relief=SOLID,width=180,height=50,fg='white',font='Calibri',image=stop,bg='#002BFF')
Stop.grid(row=8, column=3,columnspan=2)
